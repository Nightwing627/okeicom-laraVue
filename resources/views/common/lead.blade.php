	...
	<div class="l-allWrapper">
		<div class="lead__wrap">
			...
			<div class="lead__img l-flex">
				<div class="lead__img__box"><img src="{{ asset('/img/lead-image-1.jpg') }}"></div>
				<div class="lead__img__box"><img src="{{ asset('/img/lead-image-2.jpg') }}"></div>
				<div class="lead__img__box"><img src="{{ asset('/img/lead-image-3.jpg') }}"></div>
				<div class="lead__img__box"><img src="{{ asset('/img/lead-image-4.jpg') }}"></div>
			</div>
